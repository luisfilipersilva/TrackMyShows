...
public class GridViewAdapterTopRated extends ArrayAdapter {
    ...
    public GridViewAdapterTopRated(Context context, String[] imageUrls) {
        super(context, R.layout.fragment_tab3, imageUrls);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowview = inflater.inflate(R.layout.fragment_tab3,null);
