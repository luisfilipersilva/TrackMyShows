...
public class Tab2 extends Fragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && view != null) {
            ...
            imageStock = activity.getPopular( );
            listaid = activity.getTmdbIdPopular( );
            listaNome = activity.getLabelFilmesPopular( );
            listaNotasTmdb = activity.getNotasTmdbPopular( );
            listaVotosTmdb = activity.getVotosTmdbPopular( );
