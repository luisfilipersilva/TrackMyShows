 ...
 */
public class WatchlistShows extends Fragment {


    public WatchlistShows() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_watchlistshows, container, false);

        recyclerView = view.findViewById(R.id.recyclerviewWatchlistShowsTab);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && view != null) {
            ...
            String url = "https://api.themoviedb.org/3/account/"+idAccount+"/watchlist/" +
                    "tv?api_key=012d9359357024d4a012077fa7b93581&language=en-US&" +
            ...
            try {
                ...
                for (int i = 0; i < tituloJson.length(); i++) {
                    ...
                    listaNomes.add(filme.getString("original_name")); // Title
