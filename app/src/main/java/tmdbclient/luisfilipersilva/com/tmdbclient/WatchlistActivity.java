...
public class WatchlistActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tabsWatchlist);

        mViewPager.addOnPageChangeListener(new TabLayout.TabLayoutOnPageChangeListener(tabLayout));
        tabLayout.addOnTabSelectedListener(new TabLayout.ViewPagerOnTabSelectedListener(mViewPager));

        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabAddMovie);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_movies) {
            ...
            Intent intent = new Intent(WatchlistActivity.this,ShowsActivity.class);
            startActivity(intent);
            ...
            if(request_token == null){
                ...
                Intent intent = new Intent(WatchlistActivity.this,AuthenticationActivity.class);
                startActivity(intent);
            }
            else{
                Toast.makeText(WatchlistActivity.this,"Conectado ao TMDb",Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    WatchlistMovies tab1 = new WatchlistMovies();
                    return tab1;
                case 1:
                    WatchlistShows tab2 = new WatchlistShows();
                    return tab2;
            }
            return null;
        }
